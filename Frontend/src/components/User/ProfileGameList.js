...
background:${props => props.active === props.name ? '#D9756C' :'#F2D3AC'};
margin: 0;
margin-bottom: 10px;
width: 270px;
height: 460px;
...
export const ProfileGameList = () => {
    ...
    <Wrapper>
        <ButtonContainer>
            <Button active={active} name="favourites" onClick={() => handleClick('favourites')}>💗</Button>
            <Button active={active} name="wishlist" onClick={() => handleClick('wishlist')}>💎</Button>
            <Button active={active} name="ownedgames" onClick={() => handleClick('ownedgames')}>✅</Button>
        </ButtonContainer>
